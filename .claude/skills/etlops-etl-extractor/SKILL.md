---
description: "Use when you need to pull data from a specific source using CLI tools or the ETLService API. The extractor knows every tool's flags, exit codes, and edge cases.
"
user-invocable: true
maxTurns: 25
---

---
description: "Activate when the user needs to create, analyze, extract, audit, or convert Standard Operating Procedures. This is the entry point for all SOP Factory operations."
user-invocable: true
effort: high
maxTurns: 50
---

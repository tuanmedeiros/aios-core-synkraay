---
description: "Activate when a new SOP needs to be written for human consumption. Use for creating, drafting, or rewriting SOPs in structured, human-readable format with all 11 required sections."
user-invocable: true
maxTurns: 25
---
# sop-creator

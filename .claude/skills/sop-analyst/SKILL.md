---
description: "Activate when an existing SOP needs to be evaluated, scored, graded, or benchmarked against quality standards. Use for gap analysis and improvement recommendations."
user-invocable: true
maxTurns: 25
---
# sop-analyst

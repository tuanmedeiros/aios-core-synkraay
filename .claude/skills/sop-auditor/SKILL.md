---
description: "When an SOP needs compliance verification, quality certification, or regulatory audit. Final quality gate before an SOP is released for production use."
user-invocable: true
maxTurns: 25
---
# sop-auditor

---
description: "Activate when SOPs need to be created in machine-readable formats for AI agent execution, workflow automation, or integration with orchestration systems. Use for YAML/JSON SOP generation, state machine design, and tool-chain mapping."
user-invocable: true
effort: high
maxTurns: 50
---

---
description: "Use when you need to extract, transform, or load content from any source. The chief analyzes the request, picks the right tool, and coordinates execution.
"
user-invocable: true
effort: high
maxTurns: 50

...
1. Construir array de tasks para `/swarm-execute`:
   ...
   [
     {
       "agent": "brand--keller-brand-equity",
       "prompt": "CBBE diagnosis para {brand}. Contexto: {inputs da fase anterior}",
       "mode": "write",
       "effort": 5,
     ...
     {
       "agent": "brand--aaker-brand-identity",
       "prompt": "Identity architecture para {brand}. Contexto: {inputs}",
       "mode": "write",
       "effort": 5,
       "file_set": ["outputs/brand/{brand}/identity-architecture.md"]
     },
     {
       "agent": "brand--sharp-brand-science",
       "prompt": "Growth strategy para {brand}. Contexto: {inputs}",
       "mode": "write",
       "effort": 5,
